  ...
  return (
    <div className="sticky-bottom-bar lg:hidden">
      <a
        ...
        className="flex-1 cta-button flex items-center justify-center gap-2 text-sm"
      >
      ...
      <a
        ...
        className="contact-icon-whatsapp w-12 h-12"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="contact-icon-messenger w-12 h-12"
      >
